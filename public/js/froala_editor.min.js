...
! function(e, t) {
    ...
    H.LinkRegExCommon = "[".concat("a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_\\.", "]{1,}"), H.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;\\/~+#-\\'*-_{}]*)|())", H.LinkRegExTLD = "((".concat(H.LinkRegExCommon, ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))"), H.LinkRegExHTTP = "((ftp):\\/\\/".concat(H.LinkRegExCommon, ")"), H.LinkRegExAuth = "((ftp|http|):\\/\\/[\\u0021-\\uffff]{1,}@".concat(H.LinkRegExCommon, ")"), H.LinkRegExWWW = "(www\\.".concat(H.LinkRegExCommon, "\\.[a-z0-9-]{2,24})"), H.LinkRegEx = "(".concat(H.LinkRegExTLD, "|").concat(H.LinkRegExHTTP, "|").concat(H.LinkRegExWWW, "|").concat(H.LinkRegExAuth, ")").concat(H.LinkRegExEnd), H.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], H.MAIL_REGEX = /.+@.+\..+/i, H.MODULES.helpers = function(i) {
        var a, s = i.$;
        ...
        return {
            ...
            isEmail: function u(e) {
                return !/^(?:|ftps?:|)\/\//i.test(e) && H.MAIL_REGEX.test(e)
            },
            ...
            sanitizeURL: function v(e) {
                return /^(?:|ftps?:|)\/\//i.test(e) ? e : /^([A-Za-z]:(\\){1,2}|[A-Za-z]:((\\){1,2}[^\\]+)+)(\\)?$/i.test(e) ? e : new RegExp("^(".concat(H.LinkProtocols.join("|"), "):\\/\\/"), "i").test(e) ? e : e = encodeURIComponent(e).replace(/%23/g, "#").replace(/%2F/g, "/").replace(/%25/g, "%").replace(/mailto%3A/gi, "mailto:").replace(/file%3A/gi, "file:").replace(/sms%3A/gi, "sms:").replace(/tel%3A/gi, "tel:").replace(/notes%3A/gi, "notes:").replace(/data%3Aimage/gi, "data:image").replace(/blob%3A/gi, "blob:").replace(/%3A(\d)/gi, ":$1").replace(/webkit-fake-url%3A/gi, "webkit-fake-url:").replace(/%3F/g, "?").replace(/%3D/g, "=").replace(/%26/g, "&").replace(/&amp;/g, "&").replace(/%2C/g, ",").replace(/%3B/g, ";").replace(/%2B/g, "+").replace(/%40/g, "@").replace(/%5B/g, "[").replace(/%5D/g, "]").replace(/%7B/g, "{").replace(/%7D/g, "}")
            },
            ...
            isURL: function y(e) {
                return !!/^(?:|ftps?:|)\/\//i.test(e) && (e = String(e).replace(/</g, "%3C").replace(/>/g, "%3E").replace(/"/g, "%22").replace(/ /g, "%20"), new RegExp("^".concat(H.LinkRegExHTTP).concat(H.LinkRegExEnd, "$"), "gi").test(e))
            },
